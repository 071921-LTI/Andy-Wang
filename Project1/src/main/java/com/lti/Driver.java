...
public class Driver {
	...
	public static void test() {
		...
		User empl = new User(2,"username", "password", "first", "last", "employee@email.com", employee);
		User man = new User(1,"manager", "password", "first", "last", "manager@email.com", manager);
	...
	public static void test2() {
		...
		User empl = new User(1,"username", "password", "first", "last", "employee@email.com", employee);
