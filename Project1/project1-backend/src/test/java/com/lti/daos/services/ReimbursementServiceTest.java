...
//	private UserDao ud = new UserHibernate();
	...
	private static ReimburseService rd = new ReimburseServiceImpl();
	...
	public void getReimburse() {
		assertEquals(rd.GetAllReimbursements().size(), 2);
	}
	
	@Test
	public void addReimburseValid() {
		assertEquals(rd.addReimburse(reimburse2), true);
	}
	
	
	@Test
	public void getReimburseStatus() {
		assertEquals(rd.GetReimbursesByStatus("pending").size(),3);
	}
	
	@Test
	public void updateReimburse() {
		reimburse.setReimbAmount(20);
		rd.UpdateReimbursement(reimburse);
